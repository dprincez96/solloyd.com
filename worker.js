...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body.scroll-mid .framed-product .product-name,
    body.scroll-mid .framed-product .product-desc,
    body.scroll-mid .framed-product .product-category { color: rgba(240,246,251,0.9); }
