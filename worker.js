  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root {
      ...
      --accent: #b5883a; --accent-light: rgba(181,136,58,0.10);
      --border: rgba(28,24,20,0.10); --border-strong: rgba(28,24,20,0.18); --wall: #e8e2d8;
    }
    ...
    body {
      background: linear-gradient(to bottom,#f0f9fc 0%,#d8eef7 6%,#a8d8ec 14%,#87ceeb 22%,#5fb3d4 36%,#3a8db5 50%,#1e5a8a 62%,#0a3a5e 74%,#051f3a 84%,#02060d 93%,#000000 100%);
      background-attachment: fixed; color: var(--charcoal);
    ...
    nav { position:fixed;top:0;left:0;right:0;z-index:200;display:flex;align-items:center;justify-content:space-between;padding:22px 52px;background:rgba(234,246,251,0.85);backdrop-filter:blur(14px);border-bottom:1px solid var(--border);transition:background 0.6s ease,border-color 0.6s ease; }
    ...
    .menu-toggle span { display:block;position:absolute;left:4px;right:4px;height:1.5px;background:var(--charcoal);transition:transform .3s ease,opacity .3s ease,top .3s ease; }
    ...
    .mobile-menu { display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:var(--warm-white);z-index:150;flex-direction:column;justify-content:center;align-items:center;gap:28px;padding:80px 24px 40px;opacity:0;pointer-events:none;transition:opacity .35s ease; }
    .mobile-menu.open { opacity:1;pointer-events:auto; }
    .mobile-menu a { font-family:'Cormorant Garamond',serif;font-size:1.9rem;font-weight:300;color:var(--charcoal);text-decoration:none;transition:color .2s; }
    .mobile-menu a:hover { color:var(--accent); }
    .mobile-menu a em { font-style:italic;color:var(--accent); }
    .mobile-menu-cta { margin-top:20px;background:var(--charcoal);color:var(--cream) !important;padding:14px 36px;font-family:'DM Mono',monospace !important;font-size:.65rem !important;font-weight:300 !important;letter-spacing:.2em;text-transform:uppercase; }
    .hero { min-height:100vh;background:linear-gradient(to bottom,rgba(234,246,251,0.4) 0%,rgba(220,240,250,0.25) 100%);display:flex;align-items:center;padding:110px 52px 80px;gap:60px;position:relative;overflow:hidden; }
    .hero::before { content:'';position:absolute;inset:0;pointer-events:none;background:repeating-linear-gradient(0deg,transparent,transparent 3px,rgba(28,24,20,.012) 3px,rgba(28,24,20,.012) 4px),repeating-linear-gradient(90deg,transparent,transparent 3px,rgba(28,24,20,.008) 3px,rgba(28,24,20,.008) 4px); }
    ...
    .hero-title { font-family:'Cormorant Garamond',serif;font-size:clamp(2.6rem,5.8vw,5.2rem);font-weight:300;line-height:1.02;color:var(--charcoal);margin-bottom:28px;opacity:0;animation:fadeUp .7s .35s forwards;transition:color .6s ease; }
    ...
    .destinations { display:flex;gap:0;overflow-x:auto;border:1px solid var(--border);background:rgba(255,255,255,0.78);backdrop-filter:blur(8px);scrollbar-width:none;transition:background .6s ease; }
    ...
    .photo-bg { width:100%;height:100%;transition:transform .7s cubic-bezier(.25,.46,.45,.94);background-size:cover;background-position:center; }
    ...
    .articles-placeholder { padding:60px 52px;text-align:center;border:1px dashed var(--border-strong);background:rgba(247,244,239,0.6);backdrop-filter:blur(8px);margin:0 52px;font-size:.65rem;color:var(--muted);line-height:1.9;letter-spacing:.05em;transition:background .6s ease,color .6s ease; }
    .articles-placeholder em { font-style:italic;color:var(--accent); }
    .country-block { padding:0 52px 60px; }
    .country-label { display:flex;align-items:baseline;gap:16px;padding-bottom:16px;margin-bottom:20px;border-bottom:1px solid var(--border); }
    .country-flag { font-size:1.2rem; }
    .country-name { font-family:'Cormorant Garamond',serif;font-size:1.5rem;font-weight:300;color:var(--charcoal);transition:color .6s ease; }
    .country-tags { font-size:.56rem;letter-spacing:.2em;text-transform:uppercase;color:var(--muted-light);transition:color .6s ease; }
    ...
    .portfolio-shop-nudge { margin:0 52px 72px;padding:32px 40px;border:1px solid var(--border);background:rgba(247,244,239,0.85);backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;transition:background .6s ease; }
    .nudge-text { font-size:.7rem;color:var(--muted);letter-spacing:.06em;line-height:1.6;transition:color .6s ease; }
    .nudge-link { font-family:'Cormorant Garamond',serif;font-size:1.2rem;font-weight:300;font-style:italic;color:var(--charcoal);text-decoration:none;border-bottom:1px solid var(--accent);padding-bottom:2px;transition:color .6s ease;white-space:nowrap; }
    ...
    .framed-mockup { background:rgba(232,226,216,0.85);backdrop-filter:blur(8px);padding:44px 44px 60px;display:flex;align-items:center;justify-content:center;position:relative;margin-bottom:22px;border:1px solid var(--border);transition:box-shadow .3s,background .6s ease; }
    ...
    .print-art { width:100%;height:100%;display:block;background-size:cover;background-position:center; }
    ...
    .gear-cat { background:rgba(247,244,239,0.85);backdrop-filter:blur(8px);border:1px solid var(--border);padding:32px 28px;transition:box-shadow .25s,background .6s ease; }
    ...
    .profile-frame { position:relative;width:200px;height:200px;border-radius:50%;overflow:hidden;background:#ffffff;align-self:flex-start;box-shadow:0 6px 28px rgba(28,24,20,.12),0 2px 8px rgba(28,24,20,.08);border:3px solid #ffffff; }
    ...
    .contact-email { display:inline-block;font-family:'Cormorant Garamond',serif;font-size:clamp(1.8rem,3.6vw,2.8rem);font-weight:300;font-style:italic;color:var(--charcoal);text-decoration:none;padding:18px 40px;border-top:1px solid var(--border);border-bottom:1px solid var(--border);transition:color .6s ease,border-color .6s ease;margin-bottom:32px; }
    ...
    body.scroll-mid .section-title,body.scroll-mid .country-name,body.scroll-mid .about-text h2,body.scroll-mid .contact-title,body.scroll-mid .product-name,body.scroll-mid .about-quote,body.scroll-mid .insta-handle a,body.scroll-mid .gear-name strong,body.scroll-mid .gear-item,body.scroll-mid .product-price,body.scroll-mid .dest-name { color:#f0f6fb; }
    body.scroll-mid .hero-sub,body.scroll-mid .about-text p,body.scroll-mid .product-desc,body.scroll-mid .nudge-text,body.scroll-mid .gear-intro,body.scroll-mid .contact-sub,body.scroll-mid .articles-placeholder,body.scroll-mid .gear-name span,body.scroll-mid .dest-status { color:rgba(240,246,251,0.75); }
    body.scroll-mid .section-link,body.scroll-mid .footer-copy,body.scroll-mid .contact-note,body.scroll-mid .insta-handle,body.scroll-mid .badge-tag { color:rgba(240,246,251,0.6); }
    body.scroll-mid .badge-tag { border-color:rgba(240,246,251,0.3); }
    body.scroll-mid .stats-band,body.scroll-mid .destinations,body.scroll-mid .gear-cat,body.scroll-mid .articles-placeholder,body.scroll-mid .portfolio-shop-nudge,body.scroll-mid .about-section { background:rgba(255,255,255,0.08);border-color:rgba(255,255,255,0.12); }
    body.scroll-mid .framed-mockup { background:rgba(180,210,230,0.35);border-color:rgba(255,255,255,0.3); }
    body.scroll-mid .shop-panel { background:rgba(10,40,70,0.4); }
    body.scroll-mid .framed-product .product-name,body.scroll-mid .framed-product .product-desc,body.scroll-mid .framed-product .product-category { color:rgba(240,246,251,0.9); }
    body.scroll-mid .stat-num { color:#ffd27a; }
    body.scroll-deep .section-title,body.scroll-deep .country-name,body.scroll-deep .contact-title,body.scroll-deep .insta-handle a { color:#ffffff; }
    body.scroll-deep .contact-email { color:#ffffff;border-color:rgba(255,255,255,0.25); }
    body.scroll-deep nav { background:rgba(0,0,0,0.6) !important;border-bottom-color:rgba(255,255,255,0.08); }
    ...
    body.scroll-deep .footer-logo,body.scroll-deep .footer-links a { color:rgba(255,255,255,0.7); }
    ...
    @media(max-width:768px){
      ...
      .grid-wide{grid-template-columns:1fr;} .cg-tall{aspect-ratio:3/2;}
      .portfolio-shop-nudge{margin:0 24px 48px;padding:24px;flex-direction:column;text-align:center;}
      .shop-header{padding:48px 24px 0;} .shop-tabs-row{padding:0 24px;overflow-x:auto;} .shop-panel{padding:0 24px;}
      .articles-placeholder{margin:0 24px;padding:40px 24px;}
      .framed-grid{grid-template-columns:1fr;gap:44px;} .wallpaper-grid{grid-template-columns:repeat(2,1fr);}
...
<body>
  ...
  <section id="portfolio">
    <div class="sec-pad reveal">
      <div class="section-header" style="margin-bottom:0;"><h2 class="section-title">Featured <em>Work</em></h2></div>
    </div>
    <div style="height:36px;"></div>

    <!-- JAPAN — KYOTO -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇯🇵</span><span class="country-name">Japan — Kyoto</span><span class="country-tags">Culture · Temples · Streets</span></div>
      <div class="country-grid grid-japan">
        <div class="photo-card cg-1"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-kyoto-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Kyoto · Japan</span>Temples · Culture</div></div></div>
        <div class="photo-card cg-2"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-kyoto-2.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Kyoto · Japan</span>Streets · Tradition</div></div></div>
        <div class="photo-card cg-3"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-kyoto-3.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Kyoto · Japan</span>Architecture</div></div></div>
      </div>
    </div>

    <!-- JAPAN — MT FUJI -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇯🇵</span><span class="country-name">Japan — Mt Fuji</span><span class="country-tags">Landscape · Iconic · Sunrise</span></div>
      <div class="country-grid grid-wide">
        <div class="photo-card cg-wide"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-mtfuji-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Mt Fuji · Japan</span>Iconic · Landscape</div></div></div>
        <div class="photo-card cg-tall"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-mtfuji-2.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Mt Fuji · Japan</span>Golden Hour</div></div></div>
      </div>
    </div>

    <!-- JAPAN — HOKKAIDO WINTER -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇯🇵</span><span class="country-name">Japan — Hokkaido</span><span class="country-tags">Winter · Snow · Long Exposure</span></div>
      <div class="country-grid grid-japan">
        <div class="photo-card cg-1"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-hokkaido-winter-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hokkaido · Japan</span>Winter · Snow</div></div></div>
        <div class="photo-card cg-2"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-hokkaido-winter-2.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hokkaido · Japan</span>Long Exposure</div></div></div>
        <div class="photo-card cg-3"><div class="photo-bg" style="height:100%;background-image:url('${R2}/japan-hokkaido-winter-3.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hokkaido · Japan</span>Winter Landscape</div></div></div>
      </div>
    </div>

    <!-- SINGAPORE — MOON & SUNRISE -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇸🇬</span><span class="country-name">Singapore — Moon & Sunrise</span><span class="country-tags">Sun/Moon · Golden Hour · Sky</span></div>
      <div class="country-grid grid-wide">
        <div class="photo-card cg-wide"><div class="photo-bg" style="height:100%;background-image:url('${R2}/singapore-moon-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Singapore</span>Moon · Night Sky</div></div></div>
        <div class="photo-card cg-tall"><div class="photo-bg" style="height:100%;background-image:url('${R2}/singapore-sunrise-1.jpg');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Singapore</span>Sunrise · Golden Hour</div></div></div>
      </div>
    </div>

    <!-- SINGAPORE — ARCHITECTURE & STREETS -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇸🇬</span><span class="country-name">Singapore — Architecture</span><span class="country-tags">MBS · Chinatown · Streets</span></div>
      <div class="country-grid grid-japan">
        <div class="photo-card cg-1"><div class="photo-bg" style="height:100%;background-image:url('${R2}/singapore-mbs-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Singapore</span>Marina Bay Sands</div></div></div>
        <div class="photo-card cg-2"><div class="photo-bg" style="height:100%;background-image:url('${R2}/singapore-architecture-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Singapore</span>Architecture · Night</div></div></div>
        <div class="photo-card cg-3"><div class="photo-bg" style="height:100%;background-image:url('${R2}/singapore-chinatown-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Singapore</span>Chinatown · Culture</div></div></div>
      </div>
    </div>
    ...
    <div class="country-block reveal">
      ...
      <div class="country-grid grid-japan">
        <div class="photo-card cg-1"><div class="photo-bg" style="height:100%;background-image:url('${R2}/hongkong-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hong Kong</span>Streets · Neon</div></div></div>
        <div class="photo-card cg-2"><div class="photo-bg" style="height:100%;background-image:url('${R2}/hongkong-2.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hong Kong</span>Taxis · Culture</div></div></div>
        <div class="photo-card cg-3"><div class="photo-bg" style="height:100%;background-image:url('${R2}/hongkong-3.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hong Kong</span>Cityscape</div></div></div>
      </div>
    </div>

    <!-- THAILAND — BANGKOK -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇹🇭</span><span class="country-name">Thailand — Bangkok</span><span class="country-tags">Culture · Streets · Temples</span></div>
      <div class="country-grid grid-wide">
        <div class="photo-card cg-wide"><div class="photo-bg" style="height:100%;background-image:url('${R2}/thailand-bangkok-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Bangkok · Thailand</span>Culture · Streets</div></div></div>
        <div class="photo-card cg-tall"><div class="photo-bg" style="height:100%;background-image:url('${R2}/thailand-bangkok-2.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Bangkok · Thailand</span>Golden Hour</div></div></div>
      </div>
    </div>

    <!-- MALAYSIA -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇲🇾</span><span class="country-name">Malaysia</span><span class="country-tags">Penang · KL · Milky Way</span></div>
      <div class="country-grid grid-japan">
        <div class="photo-card cg-1"><div class="photo-bg" style="height:100%;background-image:url('${R2}/malaysia-penang-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Penang · Malaysia</span>Streets · Heritage</div></div></div>
        <div class="photo-card cg-2"><div class="photo-bg" style="height:100%;background-image:url('${R2}/malaysia-milkyway-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Malaysia</span>Milky Way · Astrophotography</div></div></div>
        <div class="photo-card cg-3"><div class="photo-bg" style="height:100%;background-image:url('${R2}/malaysia-kualalumpur-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Kuala Lumpur · Malaysia</span>Cityscape · Aerial</div></div></div>
      </div>
    </div>

    <!-- VIETNAM -->
    <div class="country-block reveal">
      <div class="country-label"><span class="country-flag">🇻🇳</span><span class="country-name">Vietnam</span><span class="country-tags">Sapa · Hanoi · Ninh Binh</span></div>
      <div class="country-grid grid-wide">
        <div class="photo-card cg-wide"><div class="photo-bg" style="height:100%;background-image:url('${R2}/vietnam-sapa-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Sapa · Vietnam</span>Rice Terraces · Nature</div></div></div>
        <div class="photo-card cg-tall"><div class="photo-bg" style="height:100%;background-image:url('${R2}/vietnam-hanoi-1.JPG');background-size:cover;background-position:center;"></div><div class="photo-overlay"><div class="photo-meta"><span>Hanoi · Vietnam</span>Culture · Streets</div></div></div>
      </div>
    </div>
  ...
  <section id="shop">
    ...
    <div class="shop-panel active" id="panel-prints">
      <div class="framed-grid">
        <a href="https://gumroad.com" target="_blank" class="framed-product reveal">
          <div class="framed-mockup"><div class="print-nail"></div><div class="print-frame"><div class="print-inner landscape"><div class="print-art" style="height:100%;background-image:url('${R2}/japan-hokkaido-winter-1.JPG');background-size:cover;background-position:center;"></div></div></div><div class="print-shadow"></div></div>
        ...
        <a href="https://gumroad.com" target="_blank" class="framed-product reveal">
          <div class="framed-mockup"><div class="print-nail"></div><div class="print-frame"><div class="print-inner portrait"><div class="print-art" style="height:100%;background-image:url('${R2}/singapore-moon-1.JPG');background-size:cover;background-position:center;"></div></div></div><div class="print-shadow"></div></div>
        ...
        <a href="https://gumroad.com" target="_blank" class="framed-product reveal">
          <div class="framed-mockup"><div class="print-nail"></div><div class="print-frame"><div class="print-inner widescreen"><div class="print-art" style="height:100%;background-image:url('${R2}/malaysia-milkyway-1.JPG');background-size:cover;background-position:center;"></div></div></div><div class="print-shadow"></div></div>
    ...
    <div class="shop-panel" id="panel-wallpaper">
      <div class="wallpaper-grid">
        <a href="https://gumroad.com" target="_blank" class="wallpaper-product reveal"><div class="phone-wrap"><div class="phone-shell"><div class="phone-island"></div><div class="phone-screen" style="background-image:url('${R2}/phone-wallpaper-1.JPG');background-size:cover;background-position:center;"></div></div></div><div class="wallpaper-label"><p class="product-category">Mobile Wallpaper</p><h3 class="product-name">Milky Way, Japan</h3><div class="product-footer"><span class="product-buy">Enquire →</span></div></div></a>
        <a href="https://gumroad.com" target="_blank" class="wallpaper-product reveal"><div class="phone-wrap"><div class="phone-shell"><div class="phone-island"></div><div class="phone-screen" style="background-image:url('${R2}/phone-wallpaper-2.JPG');background-size:cover;background-position:center;"></div></div></div><div class="wallpaper-label"><p class="product-category">Mobile Wallpaper</p><h3 class="product-name">Singapore Skyline</h3><div class="product-footer"><span class="product-buy">Enquire →</span></div></div></a>
        <a href="https://gumroad.com" target="_blank" class="wallpaper-product reveal"><div class="phone-wrap"><div class="phone-shell"><div class="phone-island"></div><div class="phone-screen" style="background-image:url('${R2}/singapore-moon-2.JPG');background-size:cover;background-position:center;"></div></div></div><div class="wallpaper-label"><p class="product-category">Mobile Wallpaper</p><h3 class="product-name">Singapore Moon</h3><div class="product-footer"><span class="product-buy">Enquire →</span></div></div></a>
        <a href="https://gumroad.com" target="_blank" class="wallpaper-product reveal"><div class="phone-wrap"><div class="phone-shell"><div class="phone-island"></div><div class="phone-screen" style="background-image:url('${R2}/japan-sunrise-1.JPG');background-size:cover;background-position:center;"></div></div></div><div class="wallpaper-label"><p class="product-category">Mobile Wallpaper</p><h3 class="product-name">Japan Sunrise</h3><div class="product-footer"><span class="product-buy">Enquire →</span></div></div></a>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="insta-section">
      ...
      <div class="insta-grid">
        <div class="insta-cell"><div class="insta-bg" style="background-image:url('${R2}/singapore-moon-3.JPG');background-size:cover;background-position:center;"></div><div class="insta-overlay">＋</div></div>
        <div class="insta-cell"><div class="insta-bg" style="background-image:url('${R2}/japan-kyoto-1.JPG');background-size:cover;background-position:center;"></div><div class="insta-overlay">＋</div></div>
        <div class="insta-cell"><div class="insta-bg" style="background-image:url('${R2}/malaysia-penang-1.JPG');background-size:cover;background-position:center;"></div><div class="insta-overlay">＋</div></div>
        <div class="insta-cell"><div class="insta-bg" style="background-image:url('${R2}/hongkong-4.JPG');background-size:cover;background-position:center;"></div><div class="insta-overlay">＋</div></div>
        <div class="insta-cell"><div class="insta-bg" style="background-image:url('${R2}/thailand-bangkok-3.JPG');background-size:cover;background-position:center;"></div><div class="insta-overlay">＋</div></div>
        <div class="insta-cell"><div class="insta-bg" style="background-image:url('${R2}/vietnam-sapa-2.JPG');background-size:cover;background-position:center;"></div><div class="insta-overlay">＋</div></div>
      </div>
      <div class="insta-cta">
  ...
  <footer>
    ...
    <ul class="footer-links">
      <li><a href="#portfolio">Portfolio</a></li><li><a href="#shop">Shop</a></li><li><a href="#articles">Articles</a></li>
      <li><a href="#gears">Gears</a></li><li><a href="#about">About</a></li><li><a href="#contact">Contact</a></li>
      <li><a href="https://instagram.com/being_lloyds" target="_blank">Instagram</a></li>
    </ul>
  ...
  <script>
    ...
    document.addEventListener('contextmenu',e=>{if(e.target.classList.contains('photo-bg')||e.target.classList.contains('print-art')||e.target.classList.contains('insta-bg')||e.target.classList.contains('hframe-inner')||e.target.classList.contains('phone-screen')){e.preventDefault();return false;}});
    document.addEventListener('dragstart',e=>{if(e.target.classList.contains('photo-bg')||e.target.classList.contains('print-art')||e.target.classList.contains('insta-bg')||e.target.classList.contains('hframe-inner')||e.target.classList.contains('phone-screen')){e.preventDefault();return false;}});
  </script>
</body>
</html>`;
